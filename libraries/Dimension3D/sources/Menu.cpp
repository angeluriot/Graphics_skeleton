...
// Construit une ligne � partir d'une autre ligne
...
// Construit une ligne � partir de ces propri�t�s
...
// Construit une case � partir d'une autre case
...
// Construit une case � partir de ces propri�t�s
...
// Construit une variable � partir d'une autre variable
...
// Construit une variable � partir de ces param�tres
...
// Construit un menu � partir d'un autre menu
...
// Construit un menu � partir de ces param�tres
...
// Initialise un menu � partir de ces param�tres
...
void Menu::reload(const sf::Color& background)
{
	...
	texts_font.loadFromFile("resources/fonts/GoogleSans-Bold.ttf");
}
...
// Initialise les valeurs affich�es
...
{
	start_texture.loadFromFile("resources/textures/start.png");
	start_texture_grabbed.loadFromFile("resources/textures/start_grabbed.png");
...
// Donne la valeur d'une variable � partir de son nom
...
// Construit un bouton recommencer � partir d'un autre
...
// Construit un bouton recommencer � partir de ces param�tres
...
Restart::Restart(const double& start_size, const double& start_x_position, const double& start_y_position, const sf::Color& start_color)
{
	...
	texture.loadFromFile("resources/textures/restart.png");
	texture_grabbed.loadFromFile("resources/textures/restart_grabbed.png");
...
// Met � jour le bouton recommencer
...
// Transforme un nombre r�el en text
